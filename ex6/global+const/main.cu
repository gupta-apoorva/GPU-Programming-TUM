...
__global__ void cuda_convolution_original(float *cuda_imgIn, float* imgOut_cuda, int w, int h, int nc, int radius){
...
// CPU convolution 
    ...
    cuda_convolution_original <<<grid, block>>> (imgIn_cuda, imgOut_cuda, w, h, nc, radius);
